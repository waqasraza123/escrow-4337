...
- Account displays a readiness/progress panel, saved-report count, total scenario coverage, next missing scenario, bundle readiness, passing/failing scenario counts, compact session/API/snapshot/profile posture pills, per-scenario latest outcome pills, newest report scenario, newest report outcome, newest report timestamp, and newest check counts
