...
- Account can share a coverage bundle containing the current coverage summary plus the latest exact saved report for each scenario that has a readable saved report
