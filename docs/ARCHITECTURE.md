...
- The auth module now uses a provider-backed OTP email boundary with rollback-safe issuance plus rotating refresh-token sessions with replay-triggered revocation, but still needs live relay validation and further auth hardening.
