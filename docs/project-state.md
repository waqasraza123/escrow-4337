...
- Operations health now includes a replay-backed persisted-timeline reconciliation pass, but broader chain event ingestion and reconciliation against indexed onchain truth are still pending.
