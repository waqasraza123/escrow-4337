...
- `apps/web`: Next.js client console with OTP auth, browser-wallet-native plus manual SIWE wallet-link challenge handling, smart-account provisioning, authenticated job listing, lifecycle mutation forms, and audit visibility wired to the API.
