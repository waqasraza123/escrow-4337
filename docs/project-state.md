...
- The launch-candidate join handoff is now a copied share-link plus exact worker-wallet binding; there is still no automated invite delivery, wallet rebinding flow, or multi-contractor contract model.
