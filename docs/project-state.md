...
- Richer execution-failure diagnostics, stale-job escalation beyond manual operator claims, and a separate ingestion or reconciliation pipeline are still pending.
