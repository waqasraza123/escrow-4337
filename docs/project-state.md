...
## Current Roadmap
- Finish production-facing backend integrations on top of the new persistence layer and smart-account flow, including deployed Postgres migration flow, live relay/provider validation, and remaining auth hardening.
