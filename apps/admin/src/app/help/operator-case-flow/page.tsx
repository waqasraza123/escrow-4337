    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <SurfaceCard className={styles.heroCard} elevated>
          <div>
            ...
            <strong>/operator/cases/&lt;job-id&gt;</strong>
          </div>
          <div>
      ...
      <section className={styles.panel}>
        ...
        <div className={styles.stack}>
          <FeatureCard className={styles.panel} title="1. Load the disputed case" body="Open the specific `/operator/cases/<job-id>` route so the console can load the public bundle, dispute state, and receipts for that escrow job." />
          ...
          <div className={styles.inlineActions}>
            ...
            <Button asChild variant="secondary" className={styles.secondaryButton}>
              <Link href="/operator">Go to dashboard</Link>
            </Button>
          </div>
        </div>
      </section>
