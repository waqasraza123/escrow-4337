const styles = {
  ...
  topBar:
    'relative overflow-hidden flex flex-wrap items-center justify-between gap-4 rounded-[1.7rem] border border-[var(--surface-border)] bg-[rgba(10,15,22,0.58)] px-5 py-4 shadow-[var(--surface-shadow)] backdrop-blur-xl before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-[linear-gradient(90deg,transparent,rgba(158,204,255,0.46),transparent)]',
  ...
  heroCard:
    'relative overflow-hidden rounded-[1.75rem] border border-[var(--surface-border)] bg-[linear-gradient(180deg,rgba(12,17,24,0.82),rgba(19,28,41,0.9))] p-6 shadow-[var(--surface-shadow-strong)] backdrop-blur-xl before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-[linear-gradient(90deg,transparent,rgba(158,204,255,0.4),transparent)]',
  panel:
    'relative overflow-hidden rounded-[1.75rem] border border-[var(--surface-border)] bg-[linear-gradient(180deg,rgba(12,17,24,0.8),rgba(19,28,41,0.88))] p-6 shadow-[var(--surface-shadow-strong)] backdrop-blur-xl before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-[linear-gradient(90deg,transparent,rgba(158,204,255,0.38),transparent)]',
  ...
  lookupRow:
    'flex flex-wrap gap-3 [&_input]:min-h-12 [&_input]:flex-[1_1_420px] [&_input]:rounded-2xl [&_input]:border [&_input]:border-[rgba(145,164,189,0.2)] [&_input]:bg-[rgba(10,15,22,0.55)] [&_input]:px-4 [&_input]:py-3.5 [&_input]:text-[var(--foreground)] [&_input]:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] [&_input]:backdrop-blur-xl',
  inlineActions: 'flex flex-wrap gap-3',
  fieldGrid: 'flex flex-wrap items-stretch gap-3',
  field:
    'grid flex-[1_1_220px] gap-2 [&_span:first-child]:text-[0.78rem] [&_span:first-child]:uppercase [&_span:first-child]:tracking-[0.08em] [&_span:first-child]:text-[var(--muted-foreground)] [&_input]:min-h-12 [&_input]:rounded-2xl [&_input]:border [&_input]:border-[rgba(145,164,189,0.2)] [&_input]:bg-[rgba(10,15,22,0.55)] [&_input]:px-4 [&_input]:py-3.5 [&_input]:text-[var(--foreground)] [&_input]:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] [&_input]:backdrop-blur-xl [&_select]:min-h-12 [&_select]:rounded-2xl [&_select]:border [&_select]:border-[rgba(145,164,189,0.2)] [&_select]:bg-[rgba(10,15,22,0.55)] [&_select]:px-4 [&_select]:py-3.5 [&_select]:text-[var(--foreground)] [&_select]:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] [&_select]:backdrop-blur-xl [&_textarea]:min-h-28 [&_textarea]:resize-y [&_textarea]:rounded-2xl [&_textarea]:border [&_textarea]:border-[rgba(145,164,189,0.2)] [&_textarea]:bg-[rgba(10,15,22,0.55)] [&_textarea]:px-4 [&_textarea]:py-3.5 [&_textarea]:text-[var(--foreground)] [&_textarea]:shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] [&_textarea]:backdrop-blur-xl',
  ...
  timelineCard:
    'rounded-[1.25rem] border border-[rgba(145,164,189,0.16)] bg-[rgba(10,15,22,0.52)] p-4 shadow-[var(--surface-shadow)] backdrop-blur-xl [&_code]:mt-2 [&_code]:block [&_code]:overflow-wrap-anywhere [&_code]:whitespace-pre-wrap [&_pre]:mt-2.5 [&_pre]:overflow-wrap-anywhere [&_pre]:whitespace-pre-wrap [&_small]:mt-2 [&_small]:block [&_small]:text-[var(--muted-foreground)]',
  walletCard:
    'rounded-[1.25rem] border border-[rgba(145,164,189,0.16)] bg-[rgba(10,15,22,0.52)] p-4 shadow-[var(--surface-shadow)] backdrop-blur-xl',
  emptyCard:
    'rounded-[1.25rem] border border-[rgba(145,164,189,0.16)] bg-[rgba(10,15,22,0.42)] p-[18px] backdrop-blur-xl',
  boundaryCard:
    'rounded-[1.25rem] border border-[rgba(145,164,189,0.16)] bg-[rgba(10,15,22,0.42)] p-[18px] backdrop-blur-xl',
  executionFailure:
