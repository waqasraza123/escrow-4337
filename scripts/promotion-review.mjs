...
function printHelp() {
  ...
  node ./scripts/promotion-review.mjs review --image-manifest <path> --deployed-smoke-record <path> --launch-promotion-record <path> --launch-evidence-manifest <path> [--output-dir <path>] [--expected-environment <env>] [--expected-repository <repo>] [--expected-candidate-run-id <id>] [--expected-smoke-run-id <id>] [--expected-launch-run-id <id>]
